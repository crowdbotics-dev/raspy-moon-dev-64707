"""
Django settings for raspy_moon_dev_64707 project.
...
ROOT_URLCONF = 'raspy_moon_dev_64707.urls'
...
WSGI_APPLICATION = 'raspy_moon_dev_64707.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "raspy_moon_dev_64707 API",
    "DESCRIPTION": "API documentation for raspy_moon_dev_64707 App",
    "VERSION": "v1",
}
